...
window.STANDS_DATA = {
  exhibitors: {
    ...
    8:  { company: _EN ? 'T&D Engineering' : 'ТиД Инженеринг ЕООД', logo: 'Logos/tid-engineering.png', status: 'occupied', website: 'https://www.tid-engineering.bg/', description: '' },
    ...
    20: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    21: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    22: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    23: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    24: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    25: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    26: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    27: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    28: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    29: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    30: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    31: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    32: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    33: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    34: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' },
    35: { company: _EN ? 'BSMEPA' : 'ИАНМСП', logo: '../images/bsmepa_logo.svg', status: 'partner', website: 'https://sme.government.bg/', description: '' }
  },
  stand_info: {
