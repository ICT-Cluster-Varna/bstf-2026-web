...
|---|---|---|
| 1 | **Лого файл** на Para.expert | Да се вземе от `https://para.expert/`; ако имате официален brand файл — по-добре. |
| 2 | **Точно изписване на името** за `alt` | Заложено е „Para.expert" — потвърди дали брандът е така (или „PARA" / друго). |
